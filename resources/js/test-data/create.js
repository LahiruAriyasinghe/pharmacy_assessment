...
$('#new_test_data_save_btn').on('click', function (e) {
    e.preventDefault();
    checkForRangeErrors();
    if (!HAS_ERRORS) {
...
$('#new_test_data_model').on('hidden.bs.modal', function (e) {
    initForm();
});

function initForm() {
    $('#test_data_form').trigger("reset");
    testDataFormValidator.resetForm();
}

function toggleSaveButton(show = true) {
    $('#new_test_data_save_btn').attr('disabled', show);
}
...
window.preferredRangeAdd = function () {
    ...
    $("#test_data_range_table tbody").append("<tr>" +
        "<td><select name='ranges[" + _id + "][gender]' id='gender_" + _id + "' class='form-control' required><option value='M'>Male</option><option value='F'>Female</option></select</td>" +
        "<td><input name='ranges[" + _id + "][age_min]' id='age_min_" + _id + "' type='text' class='form-control' required></td>" +
        "<td><input name='ranges[" + _id + "][age_max]' id='age_max_" + _id + "' type='text' class='form-control' required></td>" +
        "<td><input name='ranges[" + _id + "][range_min]' id='range_min_" + _id + "' type='text' class='form-control' required></td>" +
        "<td><input name='ranges[" + _id + "][range_max]' id='range_max_" + _id + "' type='text' class='form-control' required></td>" +
        "<td><input name='ranges[" + _id + "][condition]' id='range_condition_" + _id + "' type='text' class='form-control' required></td>" +
        "<td><a type='button' id='delete_row_" + _id + "' class='btn btn-light' onclick='preferredRangeDelete(this);'><i class='fa fa-trash-o' aria-hidden='true'></i></a></td>" +
        "</tr>");
}
