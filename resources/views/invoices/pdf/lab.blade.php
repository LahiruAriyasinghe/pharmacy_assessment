...
<head>
    <meta charset="utf-8">
    <title>LAB Invoice | {{ $invoice->id }}</title>
    <style>
        @page {
            margin: 0pt;
        }
...
<body>
    <div>
        ...
        <div style="margin-left:120pt;">
            <div style="font-size: 12px; margin-bottom: 4pt; font-weight: bold;">Invoice Lab</div>
    ...
    <div style="margin-top: 24pt;">
        ...
        <table class="table table-bordered" style="margin-top: 20pt;">
            ...
            <tbody>
                ...
                <tr>
                    <td style="text-align: left;">{{$samples[$key]->sample_no}} {{ $report->name }}</td>
                    <td style="text-align: right;">Rs. {{ number_format( $report->fee, 2, '.', ',') }}</td>
                </tr>
                @endforeach
                <tr>
                    <td style="text-align: left;">Hospital Fee</td>
                    <td style="text-align: right;">Rs. {{ number_format($invoice->hospital_fee, 2, '.', ',') }}</td>
                </tr>
            </tbody>
        </table>
